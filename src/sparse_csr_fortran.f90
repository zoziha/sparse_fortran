module sparse_csr_fortran
    ...
    contains
        ...
        procedure, private :: sparse_init_none
        procedure, private :: sparse_init_vec
        procedure, private :: sparse_init_array
        procedure :: sparse_search
        procedure :: sparse_set_capacity
        procedure :: sparse_append
        procedure :: sparse_val
        procedure :: sparse_product
    end type sparse_csr
...
contains
    ...
    subroutine sparse_init_none(this, dimx, dimy, capacity, order, eps)
    ...
    subroutine sparse_init_array(this, a, order, eps)
        class(sparse_csr), intent(inout) :: this
        real(wp), intent(in) :: a(:, :)
        character, optional, intent(in) :: order
        real(wp), optional, intent(in) :: eps
        ...
        this%num_ = count(abs(a) > this%eps)
        this%order_ = optval(order, "C")
    ...
    subroutine sparse_init_vec(this, row, col, val, dimx, dimy, order, eps)
        class(sparse_csr), intent(inout) :: this
